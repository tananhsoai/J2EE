...
@WebServlet(name = "taotknhanvien", urlPatterns = {"/taotknhanvien"})
public class taotknhanvien extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (!errorMessage.isEmpty()) {
                ...
                session.setAttribute("message", "Đã thêm một tài khoản nhân viên!");
